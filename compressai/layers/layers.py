...
class ResidualBlockWithStride(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, stride=2, is_filter = False):
        super().__init__()
...
class ResidualBlockUpsample(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, upsample=2, is_filter = False):
        super().__init__()
        self.is_filter = is_filter
...
class ResidualBlockUpsample1x1(nn.Module):
    """Residual block with sub-pixel upsampling on the last convolution.
...
class AttentionBlock(nn.Module):
    ...
    def __init__(self, N, use_sc = True):
        super().__init__()
